                                ...
                                <div class="row portfolio-grid mt-3">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                        <figure class="effect-text-in">
                                            <img src="../image/equipe/leo.jpg" alt="image" />
                                            <figcaption >
                                                <h4 class="text-dark">Léo</h4>
                                                <p style="background-color: #DFD019">Devoloppeur back-end <br>Depuis 2019 pour JALE <br>
                                                    Conctat : leo.abdellaoui@edu.ece.fr</p>
                                            </figcaption>
                                        </figure>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                        <figure class="effect-text-in">
                                            <img src="../image/equipe/astrid.jpg" style="height: 365px" alt="image" />
                                            <figcaption>
                                                <h4 class="text-dark">Astrid</h4>
                                                <p style="background-color: #DFD019">UX-designer<br>Depuis 2020 pour JALE <br>
                                                    Conctat : astrid.krekounian@edu.ece.fr</p>
                                            </figcaption>
                                        </figure>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                        <figure class="effect-text-in">
                                            <img src="../image/equipe/julie.jpg" alt="image" />
                                            <figcaption>
                                                <h4 class="text-dark">Julie</h4>
                                                <p style="background-color: #DFD019">Developpeuse full-stack <br> Depuis 2021 pour JALE
                                                    <br>
                                                    Conctat : julie.kouassi@edu.ece.fr</p>
                                            </figcaption>
                                        </figure>
                                    </div>
